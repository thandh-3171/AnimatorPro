    ...
    partial class TransitionPreviewWindow
    {
        ...
        private sealed class Animations
        {
            ...
            private bool TryShowTransitionPaused(
                out AnimancerPlayable animancer, out ITransitionDetailed transition, out AnimatorProState state)
            {
            ...
            private AnimatorProState PlayOther(object key, AnimationClip animation, float normalizedTime, float fadeDuration = 0)
            {
                var animancer = _Instance._Scene.Animancer;
