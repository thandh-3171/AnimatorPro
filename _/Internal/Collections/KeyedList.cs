...
namespace AnimatorPro
{
    ...
    /// https://website/animatorpro/api/AnimatorPro/Key
    /// 
    public class Key : Key.IListItem
    {
        /************************************************************************************************************************/

        /// <summary>An object with a <see cref="AnimatorPro.Key"/> so it can be used in a <see cref="Key.KeyedList{T}"/>.</summary>
        /// <example>
        /// It is usually easiest to just inherit from <see cref="AnimatorPro.Key"/>, but if that is not possible then the
        ...
        /// }
        /// </code></example>
        /// https://website/animatorpro/api/AnimatorPro/IListItem
        /// 
        public interface IListItem
        {
            /// <summary>The <see cref="AnimatorPro.Key"/> which stores the <see cref="KeyedList{T}"/> index of this object.</summary>
            Key Key { get; }
        }
        ...
        /// </remarks>
        /// https://website/animatorpro/api/AnimatorPro/KeyedList_1
        /// 
