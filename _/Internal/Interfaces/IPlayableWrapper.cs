...
namespace AnimatorPro
{
    ...
    /// https://website/animatorpro/api/AnimatorPro/IPlayableWrapper
    /// 
    public interface IPlayableWrapper
    {
        ...
        /// <summary>How fast the <see cref="AnimatorProState.Time"/> is advancing every frame.</summary>
        /// 
        /// <remarks>
        ...
        /// <para></para>
        /// Documentation: <see href="https://website/animatorpro/docs/manual/ik#ik-pass">IK Pass</see>
        /// </remarks>
        ...
        /// above zero. Other node types either store the value to apply to their children or don't support IK.
        /// <para></para>
        /// Documentation: <see href="https://website/animatorpro/docs/manual/ik#foot-ik">Foot IK</see>
        /// </remarks>
...
{
    /// https://website/animatorpro/api/AnimatorPro.Editor/AnimancerEditorUtilities
