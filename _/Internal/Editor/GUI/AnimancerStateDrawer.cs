...
using static AnimatorPro.Editor.AnimancerPlayableDrawer;

namespace AnimatorPro.Editor
{
    /// <summary>[Editor-Only] Draws the Inspector GUI for an <see cref="AnimatorProState"/>.</summary>
    /// https://website/animatorpro/api/AnimatorPro.Editor/AnimancerStateDrawer_1
    /// 
    public class AnimancerStateDrawer<T> : AnimancerNodeDrawer<T> where T : AnimatorProState
    {
        /************************************************************************************************************************/
        ...
        /// <summary>Determines whether the <see cref="AnimatorProState.MainObject"/> field can occupy the whole line.</summary>
        ...
        /// <see cref="AnimatorProState.MainObject"/>, otherwise just a simple text label.
        /// <para></para>
        ...
        /// <summary>
        /// Gets the current <see cref="AnimatorProState.Time"/>.
        /// If the state is looping, the value is modulo by the <see cref="AnimatorProState.Length"/>.
        /// </summary>
        ...
        /// <summary>Draws a slider for controlling the current <see cref="AnimatorProState.Time"/>.</summary>
        ...
        {
            menu.AddDisabledItem(new GUIContent($"{DetailsPrefix}{nameof(AnimatorProState.Key)}: {Target.Key}"));

            var length = Target.Length;
            if (!float.IsNaN(length))
                menu.AddDisabledItem(new GUIContent($"{DetailsPrefix}{nameof(AnimatorProState.Length)}: {length}"));
            ...
            GenericMenu.MenuFunction clearEvent, GenericMenu.MenuFunction removeEvent)
        {
            ...
            menu.AddDisabledItem(new GUIContent($"{name}{nameof(AnimatorProState.NormalizedTime)}: {animancerEvent.normalizedTime}"));
