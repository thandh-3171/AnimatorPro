...
namespace AnimatorPro.Editor
{
    ...
    /// https://website/animatorpro/api/AnimatorPro.Editor/NamedAnimancerComponentEditor
    /// 
    [CustomEditor(typeof(NamedAnimatorProComponent), true), CanEditMultipleObjects]
