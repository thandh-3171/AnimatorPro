...
namespace AnimatorPro
{
    ...
    /// 
    public abstract partial class AnimatorProState : AnimancerNode, IAnimationClipCollection
    {
        /************************************************************************************************************************/
        #region Graph
        /************************************************************************************************************************/
        ...
        /// <remarks>
        /// Use <see cref="AnimancerLayer.AddChild(AnimatorProState)"/> instead of this method to connect a state to an
        ...
        /// <summary>[Internal]
        /// Called by <see cref="AnimancerNode.OnAddChild(IList{AnimatorProState}, AnimatorProState)"/> if the specified
        ...
        protected internal virtual IAnimancerNodeDrawer CreateDrawer()
            => new AnimancerStateDrawer<AnimatorProState>(this);
#endif
        ...
        {
            var parentState = parent as AnimatorProState;
            ...
            var state = parent as AnimatorProState;
            if (state != null)
            {
