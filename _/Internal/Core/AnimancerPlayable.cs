...
namespace AnimatorPro
{
    ...
    /// <para></para>
    /// Documentation: <see href="https://website/animatorpro/docs/manual/playing">Playing Animations</see>
    /// </remarks>
    /// 
        ...
        IEnumerator, IPlayableWrapper, IAnimationClipCollection
    {
        ...
        /// </summary>
        public const string DefaultFadeDurationNamespace = nameof(AnimatorPro);
        ...
        /// <summary>The <see cref="AnimatorProState"/>s managed by this playable.</summary>
        /// <remarks>
        ...
        /// <summary>How fast the <see cref="AnimatorProState.Time"/> of all animations is advancing every frame.</summary>
        /// 
        /// <remarks>
        ...
        /// </summary>
        private AnimancerLayer GetLocalLayer(AnimatorProState state)
        {
            if (state.Root == this)
            {
        ...
        /// returns it.
        /// </summary>
        public AnimatorProState Stop(IHasKey hasKey) => Stop(hasKey.Key);

        /// <summary>
        /// Calls <see cref="AnimatorProState.Stop"/> on the state registered with the `key` to stop it from playing and
        /// rewind it to the start.
        /// </summary>
        public AnimatorProState Stop(object key)
        {
        ...
        /// <summary>
        /// Calls <see cref="AnimatorProState.Stop"/> on all animations to stop them from playing and rewind them to the
        /// start.
        /// </summary>
        public void Stop()
        {
        ...
        public AnimatorProState Stop(AnimatorProState key)
        {
            key.Stop();
            return key;
        }
        ...
        /// Just check <see cref="AnimatorProState.IsPlaying"/>.
        /// </summary>
        [Obsolete("You should not use an AnimancerState as a key. Just check AnimancerState.IsPlaying.", true)]
        public bool IsPlaying(AnimatorProState key) => key.IsPlaying;
        ...
        /// <para></para>
        /// <see cref="AnimatorProState.Time"/> uses this value to determine whether it has accessed the playable's time
            ...
            if (OptionalWarning.AnimatorSpeed.IsEnabled() && Component != null)
            {
                    ...
                    animator.runtimeAnimatorController == null)
                {
                    ...
                    OptionalWarning.AnimatorSpeed.Log(
                        $"{nameof(Animator)}.{nameof(Animator.speed)} does not affect {nameof(AnimatorPro)}." +
