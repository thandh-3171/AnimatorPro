...
namespace AnimatorPro
{
    ...
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/AnimatorProEvent
    /// 
    public partial struct AnimancerEvent : IEquatable<AnimancerEvent>
    {
        ...
        /// <summary>The <see cref="AnimatorProState.NormalizedTime"/> at which to invoke the <see cref="callback"/>.</summary>
        ...
        /// <summary>The <see cref="AnimatorProState"/> currently triggering an event via <see cref="Invoke"/>.</summary>
        public static AnimatorProState CurrentState => _CurrentState;
        private static AnimatorProState _CurrentState;
        ...
        public void Invoke(AnimatorProState state)
        {
#if UNITY_ASSERTIONS
        ...
        /// <summary>
        /// Returns either the `minDuration` or the <see cref="AnimatorProState.RemainingDuration"/> of the
        ...
        /// </summary>
        public static float GetFadeOutDuration(AnimatorProState state, float minDuration)
        {
            if (state == null)
                return minDuration;
