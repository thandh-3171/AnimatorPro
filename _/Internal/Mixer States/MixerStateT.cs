...
namespace AnimatorPro
{
    ...
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/MixerState_1
    /// 
    public abstract class MixerState<TParameter> : ManualMixerState
    {
        ...
        /// <see href="https://website/animatorpro/docs/manual/blending/mixers#smoothing">Smoothing</see>.
        /// </remarks>
        ...
        /// </summary>
        public void CalculateThresholds(Func<AnimatorProState, TParameter> calculate)
        {
        ...
        /// </summary>
        public void Initialize(AnimationClip[] clips, Func<AnimatorProState, TParameter> calculateThreshold)
        {
            Initialize(clips);
        ...
        /// </summary>
        public AnimatorProState CreateChild(int index, AnimatorPro.ITransition transition, TParameter threshold)
        {
            SetThreshold(index, threshold);
        ...
        public void SetChild(int index, AnimatorProState state, TParameter threshold)
        {
        ...
        /// <inheritdoc/>
        public override string GetDisplayKey(AnimatorProState state) => $"[{state.Index}] {_Thresholds[state.Index]}";
