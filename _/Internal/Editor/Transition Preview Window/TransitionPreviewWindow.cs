...
namespace AnimatorPro.Editor
{
    ...
    /// </summary>
    /// <remarks>
    /// Documentation: <see href="https://website/animatorpro/docs/manual/transitions#previews">Previews</see>
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro.Editor/TransitionPreviewWindow
    /// 
    ...
    public sealed partial class TransitionPreviewWindow : SceneView
    {
        ...
        /// <summary>
        /// The <see cref="AnimatorProState.NormalizedTime"/> of the current transition. Can only be set if the property
        ...
        /// <summary>
        /// Returns the <see cref="AnimatorProState"/> of the current transition if the property being previewed matches
        /// the <see cref="TransitionDrawer.Context"/>. Otherwise returns null.
        /// </summary>
        public static AnimatorProState GetCurrentState()
        {
