...
{
    /// <inheritdoc/>
    /// https://website/animatorpro/api/AnimatorPro/PlayableAssetTransitionAsset
    ...
    /// <inheritdoc/>
    /// https://website/animatorpro/api/AnimatorPro/PlayableAssetTransition
    [Serializable]
        ...
        PlayableAssetState.ITransition, IAnimationClipCollection
    {
        ...
        /// <summary>
        /// The <see cref="Asset"/> will be used as the <see cref="AnimatorProState.Key"/> for the created state to
        /// be registered with.
        /// </summary>
