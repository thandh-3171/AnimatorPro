...
{
    /// https://website/animatorpro/api/AnimatorPro/AnimatorProState
    partial class AnimatorProState
    {
        /************************************************************************************************************************/
        ...
        /// <para></para>
        /// Documentation: <see href="https://website/animatorpro/docs/manual/events/animancer#clear-automatically">
        ...
        /// https://website/animatorpro/api/AnimatorPro/EventDispatcher
        public sealed class EventDispatcher : Key, IUpdatable
        {
            ...
            /// <see cref="ObjectPool"/>.
            /// </summary>
            internal static void Acquire(AnimatorProState state)
            {
            ...
            private AnimatorProState _State;
            ...
            private const string SequenceVersionException =
                nameof(AnimatorProState) + "." + nameof(AnimatorProState.Events) + " sequence was modified while iterating through it." +
                ...
                if (ShouldLogEndEventInterrupt(callback))
                {
                    ...
                    if (OptionalWarning.EndEventInterrupt.IsEnabled())
                        OptionalWarning.EndEventInterrupt.Log(
                            ...
                            $" state.{nameof(AnimatorProState.Events)}.{nameof(AnimancerEvent.Sequence.OnEnd)} = null" +
