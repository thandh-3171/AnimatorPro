...
namespace AnimatorPro.Editor
{
    ...
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro.Editor/AnimationClipPreview
    /// 
    ...
    internal sealed class AnimationClipPreview : ScriptableObject
    {
        ...
        private sealed class Transition : ITransitionDetailed, IAnimationClipCollection
        {
            ...
            public AnimatorProState CreateState() => new ClipState(_Clip);
            public void Apply(AnimatorProState state) { }
