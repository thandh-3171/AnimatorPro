...
namespace AnimatorPro
{
    ...
    /// 
    /// <remarks>
    /// Documentation: <see href="https://website/animatorpro/docs/manual/events/animation">Animation Events</see>
    /// </remarks>
    /// 
    /// <example>
    ...
    /// </code></example>
    /// 
    /// https://website/animatorpro/api/AnimatorPro/AnimationEventReceiver
    /// 
    public struct AnimationEventReceiver
    {
        /************************************************************************************************************************/

        private AnimatorProState _Source;
        ...
        /// </summary>
        public AnimatorProState Source
        {
            get
            {
                if (_Source == null ||
        ...
        /// <see cref="Callback"/>.
        /// </summary>
        public AnimationEventReceiver(AnimatorProState source, Action<AnimationEvent> callback)
        {
            _Source = source;
        ...
        public void Set(AnimatorProState source, Action<AnimationEvent> callback)
        {
            Source = source;
            Callback = callback;
        ...
        /// that the <see cref="AnimatorProState.Clip"/> actually has an event with the expected `name` and also to allow
        ...
        /// <see cref="AnimatorProState.Clip"/> has no event with that name, this method logs a warning.
        /// </summary>
        ...
        /// current and its <see cref="AnimatorProState.Clip"/> matches the one triggering the event.
        /// </summary>
