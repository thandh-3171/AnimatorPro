...
{
    /// <summary>[Pro-Only] Base class for <see cref="AnimatorProState"/>s which blend other states together.</summary>
    /// <remarks>
    /// Documentation: <see href="https://website/animatorpro/docs/manual/blending/mixers">Mixers</see>
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/MixerState
    /// 
    public abstract partial class MixerState : AnimatorProState
    {
        /************************************************************************************************************************/
        ...
        /// complexity a bit.
        /// </remarks>
        public abstract IList<AnimatorProState> ChildStates { get; }

        /// <inheritdoc/>
        public override int ChildCount => ChildStates.Count;

        /// <inheritdoc/>
        public override AnimatorProState GetChild(int index) => ChildStates[index];

        /// <inheritdoc/>
        public override FastEnumerator<AnimatorProState> GetEnumerator()
            => new FastEnumerator<AnimatorProState>(ChildStates);
        ...
        /// <summary>
        /// The weighted average <see cref="AnimatorProState.Time"/> of each child state according to their
        ...
        /// <summary>
        /// The weighted average <see cref="AnimatorProState.Length"/> of each child state according to their
        /// <see cref="AnimancerNode.Weight"/>.
        /// </summary>
        ...
        /// </summary>
        public AnimatorProState CreateChild(int index, ITransition transition)
        {
        ...
        public AnimatorProState CreateChild(int index, Object state)
        {
        ...
        public void SetChild(int index, AnimatorProState state) => state.SetParent(this, index);

        /************************************************************************************************************************/

        /// <summary>Connects the `state` to this mixer at its <see cref="AnimancerNode.Index"/>.</summary>
        protected internal override void OnAddChild(AnimatorProState state)
        {
        ...
        /// 
        /// <remarks>
        /// Documentation: <see href="https://website/animatorpro/docs/source/creating-custom-states">Creating Custom States</see>
        /// </remarks>
        /// 
        /// <example><code>
        ...
        private List<AnimatorProState> _SynchronizedChildren;
        ...
        /// </remarks>
        public AnimatorProState[] SynchronizedChildren
        {
            get => SynchronizedChildCount > 0 ? _SynchronizedChildren.ToArray() : Array.Empty<AnimatorProState>();
            set
            {
                if (_SynchronizedChildren == null)
                    _SynchronizedChildren = new List<AnimatorProState>();
                else
        ...
        public bool IsSynchronized(AnimatorProState state)
        {
        ...
        /// </remarks>
        public void Synchronize(AnimatorProState state)
        {
            if (state == null)
                return;
        ...
        private void SynchronizeDirect(AnimatorProState state)
        {
            if (state == null)
                return;
            ...
            if (OptionalWarning.MixerSynchronizeZeroLength.IsEnabled() && state.Length == 0)
                OptionalWarning.MixerSynchronizeZeroLength.Log(
                    $"Adding a state with zero {nameof(AnimatorProState.Length)} to the synchronization list: '{state}'." +
        ...
        public void DontSynchronize(AnimatorProState state)
        {
            var synchronizer = GetParentMixer();
        ...
        /// <summary>
        /// Synchronizes the <see cref="AnimatorProState.NormalizedTime"/>s of the <see cref="SynchronizedChildren"/> by
        ...
        public float CalculateTotalWeight(IList<AnimatorProState> states)
        {
            var total = 0f;
        ...
        /// <summary>
        /// Sets <see cref="AnimatorProState.Time"/> for all <see cref="ChildStates"/>.
        /// </summary>
        ...
        /// </summary>
        protected AnimatorProState GetNextState(ref int index)
        {
            var states = ChildStates;
            var childCount = states.Count;
        ...
        public virtual string GetDisplayKey(AnimatorProState state) => $"[{state.Index}]";
        ...
        /// <summary>
        /// Recalculates the <see cref="AnimatorProState.Duration"/> of all child states so that they add up to 1.
        /// </summary>
