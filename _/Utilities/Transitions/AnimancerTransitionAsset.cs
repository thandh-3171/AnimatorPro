...
{
    /// <inheritdoc/>
    /// https://website/animatorpro/api/AnimatorPro/AnimatorProTransitionAsset
    ...
    public class AnimancerTransitionAsset : AnimancerTransitionAsset<ITransition>
    {
        ...
        /// </summary>
        /// <remarks>
        /// Documentation: <see href="https://website/animatorpro/docs/manual/transitions/assets#unshared">
        /// Transition Assets - UnShared</see>
        /// </remarks>
        /// https://website/animatorpro/api/AnimatorPro/UnShared_3
        /// 
        [Serializable]
            ...
            where TState : AnimatorProState
        {
            ...
            /// <summary>Can this transition create a valid <see cref="AnimatorProState"/>?</summary>
            public virtual bool IsValid => _Asset.IsValid();

            /************************************************************************************************************************/

            private AnimatorProState _BaseState;
            ...
            /// </summary>
            public AnimatorProState BaseState
            {
                get => _BaseState;
                private set
                {
            ...
            /// <inheritdoc/>
            AnimatorProState ITransition.CreateState() => BaseState = _Asset.CreateState();
        ...
        /// <see href="https://website/inspector-gadgets/docs/script-inspector/object-reference-fields#nested-inspector">
