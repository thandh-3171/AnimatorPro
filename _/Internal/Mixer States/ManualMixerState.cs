...
{
    /// <summary>[Pro-Only]
    /// An <see cref="AnimatorProState"/> which blends multiple child states. Unlike other mixers, this class does not
    ...
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/ManualMixerState
    /// 
    public partial class ManualMixerState : MixerState
    {
        ...
        private AnimatorProState[] _Children = Array.Empty<AnimatorProState>();

        /// <summary>Returns the array of <see cref="_Children"/>.</summary>
        public override IList<AnimatorProState> ChildStates => _Children;
        ...
        /// <inheritdoc/>
        public override AnimatorProState GetChild(int index) => _Children[index];

        /// <inheritdoc/>
        public override FastEnumerator<AnimatorProState> GetEnumerator()
            => new FastEnumerator<AnimatorProState>(_Children, _Children.Length);
        ...
        /// </summary>
        /// <remarks><see cref="AnimatorProState.Destroy"/> will be called on any existing children.</remarks>
        public virtual void Initialize(int childCount)
        {
            ...
            _Children = new AnimatorProState[childCount];
