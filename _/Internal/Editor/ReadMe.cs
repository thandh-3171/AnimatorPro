...
{
    /// <summary>[Editor-Only] A welcome screen for <see cref="AnimatorPro"/>.</summary>
    // [CreateAssetMenu(menuName = Strings.MenuPrefix + "Read Me", order = Strings.AssetMenuOrder)]
    [HelpURL(Strings.DocsURLs.APIDocumentation + "." + nameof(AnimatorPro.Editor) + "/" + nameof(ReadMe))]
    public class ReadMe : ScriptableObject
    {
        ...
        protected virtual string ReleaseNumberPrefKey => nameof(AnimatorPro) + "." + nameof(ReleaseNumber);
        ...
        protected class Editor : UnityEditor.Editor
        {
            ...
            private void OnEnable()
            {
                ...
                if (_PreviousVersion < 0)
                    _PreviousVersion = EditorPrefs.GetInt(key, -1);// AnimatorPro v2.0 used EditorPrefs.
            ...
            {
                DoHeadingLink("Platformer Game Kit", null, "https://website/platformer", null, GUI.skin.label.fontSize);
            }
