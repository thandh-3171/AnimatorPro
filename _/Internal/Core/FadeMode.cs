...
{
    /// <summary>Determines how <see cref="AnimancerLayer.Play(AnimatorProState, float, FadeMode)"/> works.</summary>
    /// <remarks>
    /// Documentation: <see href="https://website/animatorpro/docs/manual/blending/fading">Fading</see>
    /// <para></para>
    /// Example: <see href="https://website/animatorpro/docs/examples/basics/playing-and-fading">Playing and Fading</see>
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/FadeMode
    /// 
    public enum FadeMode
    {
        ...
        /// More states have been created for the <see cref="AnimatorProState.Clip"/> than the
