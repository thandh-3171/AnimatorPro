...
namespace AnimatorPro.Editor
{
    ...
    /// https://website/animatorpro/api/AnimatorPro.Editor/AnimationType
    /// 
    ...
    /// </summary>
    /// https://website/animatorpro/api/AnimatorPro.Editor/AnimationBindings
    /// 
    public sealed class AnimationBindings : AssetPostprocessor
    {
        ...
        public sealed class BindingData
        {
            ...
            /// </summary>
            public MatchType GetMatchType(Animator animator, AnimatorProState state, StringBuilder message, bool forceGather = true)
            {
            ...
            /// </summary>
            public void LogIssues(AnimatorProState state, MatchType match)
            {
        ...
        /// </summary>
        public static void DoBindingMatchGUI(ref Rect area, AnimatorProState state)
        {
