...
{
    /// <summary>An <see cref="AnimatorProState"/> which plays an <see cref="AnimationClip"/>.</summary>
    /// <remarks>
    /// Documentation: <see href="https://website/animatorpro/docs/manual/playing/states">States</see>
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/ClipState
    /// 
    public sealed class ClipState : AnimatorProState
    {
        /************************************************************************************************************************/
