...
{
    /// <summary>[Pro-Only] An <see cref="AnimatorProState"/> which plays a <see cref="RuntimeAnimatorController"/>.</summary>
    /// <remarks>
    /// You can control this state very similarly to an <see cref="Animator"/> via its <see cref="Playable"/> property.
    /// <para></para>
    /// Documentation: <see href="https://website/animatorpro/docs/manual/animator-controllers">Animator Controllers</see>
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/ControllerState
    /// 
    public class ControllerState : AnimatorProState
    {
        /************************************************************************************************************************/
        ...
        protected override string UnsupportedSpeedMessage =>
            ...
            " https://website/animatorpro/docs/bugs/animator-controller-speed";
#endif
        ...
        /// <summary>
        /// Calls the base <see cref="AnimatorProState.Stop"/> and if <see cref="KeepStateOnStop"/> is false it also
