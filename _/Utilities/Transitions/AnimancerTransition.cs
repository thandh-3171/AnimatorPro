...
{
    /// <summary>
    /// A serializable <see cref="ITransition"/> which can create a particular type of <see cref="AnimatorProState"/>
        ...
        where TState : AnimatorProState
    {
        ...
        /// </summary>
        public AnimatorProState BaseState { get; private set; }
        ...
        /// <summary>The <see cref="AnimatorProState.Key"/> which the created state will be registered with.</summary>
        ...
        /// <inheritdoc/>
        AnimatorProState ITransition.CreateState() => CreateState();

        /************************************************************************************************************************/

        /// <inheritdoc/>
        public virtual void Apply(AnimatorProState state)
        {
        ...
        /// <summary>The <see cref="AnimatorProState.MainObject"/> that the created state will have.</summary>
        ...
        public static void ApplyDetails(AnimatorProState state, float speed, float normalizedStartTime)
        {
