...
namespace AnimatorPro
{
    partial struct AnimancerEvent
    {
        ...
        /// </remarks>
        /// https://website/animatorpro/api/AnimatorPro/Sequence
        /// 
        public partial class Sequence : IEnumerable<AnimancerEvent>
        {
            ...
            ///
            /// <remarks>
            /// Documentation: <see href="https://website/animatorpro/docs/manual/events/end">End Events</see>
            /// </remarks>
            /// 
            /// <seealso cref="OnEnd"/>
            ...
            /// <para></para>
            /// Use <see cref="AnimatorProState.NormalizedEndTime"/> to access that value.
            /// </remarks>
            /// <seealso cref="endEvent"/>
            /// <seealso cref="OnEnd"/>
            ...
            /// <summary>
            /// The default <see cref="AnimatorProState.NormalizedTime"/> for an animation to start at when playing
            ...
            public void AssertNormalizedTimes(AnimatorProState state)
            {
                if (Count == 0 ||
            ...
            /// <summary>[Assert-Conditional]
            /// Calls <see cref="AssertNormalizedTimes(AnimatorProState)"/> if `isLooping` is true.
            /// </summary>
            [System.Diagnostics.Conditional(Strings.Assertions)]
            public void AssertNormalizedTimes(AnimatorProState state, bool isLooping)
            {
                if (isLooping)
