...
namespace AnimatorPro
{
    ...
    /// #endif
    /// </code></example>
    /// https://website/animancer/api/AnimatorPro/OptionalWarning
    /// 
    [Flags]
    public enum OptionalWarning
    {
        /// <summary>
        /// A <see href="https://website/animancer/docs/introduction/features">Pro-Only Feature</see> has been
        /// used in <see href="https://website/animancer/lite">Animancer Lite</see>.
        /// </summary>
        /// 
        /// <remarks>
        /// Some <see href="https://website/animancer/docs/introduction/features">Features</see> are only
        /// available in <see href="https://website/animancer/pro">Animancer Pro</see>.
        /// <para></para>
        /// <see href="https://website/animancer/lite">Animancer Lite</see> allows you to try out those
        ...
        /// 
        /// <remarks>
        /// <see href="https://website/animancer/docs/manual/animator-controllers#native">Native</see>
        ...
        /// <see href="https://website/animancer/docs/manual/animator-controllers">Documentation</see>
        /// <para></para>
        ...
        /// <summary>
        /// An <see href="https://website/animancer/docs/manual/events/animancer">Animancer Event</see> is
        ...
        /// <see href="https://website/animancer/docs/manual/events/animancer#auto-clear">Automatically
        /// Cleared</see>.
        /// <para></para>
        /// If you play an <see cref="AnimationClip"/>, its <see cref="AnimatorProState.Events"/> will be empty so you
        /// can add whatever events you want.
        /// <para></para>
        /// But <see href="https://website/animancer/docs/manual/transitions">Transitions</see> store their own
        /// events, so if you play one then modify its <see cref="AnimatorProState.Events"/> you are actually modifying
        ...
        /// <summary>
        /// An <see href="https://website/animancer/docs/manual/events/end">End Event</see> did not actually
        /// end the animation.
        /// </summary>
        /// 
        /// <remarks>
        /// <see href="https://website/animancer/docs/manual/events/end">End Events</see> are triggered every
        /// frame after their time has passed, so in this case it might be necessary to explicitly clear the event or
        /// simply use a regular <see href="https://website/animancer/docs/manual/events/animancer">Animancer Event</see>.
        /// <para></para>
        ...
        /// <summary>
        /// <see href="https://website/animancer/docs/manual/events/animancer">Animancer Events</see> are
        /// being used on a state that does not properly support them so they might not work as intended.
        /// </summary>
        /// 
        /// <remarks>
        /// <see href="https://website/animancer/docs/manual/events/animancer">Animancer Events</see> on a
        /// <see cref="ControllerState"/> will be triggered based on its <see cref="AnimatorProState.NormalizedTime"/>,
        ...
        /// to use <see href="https://website/animancer/docs/manual/events/animation">Animation Events</see>
        /// instead.
        /// <para></para>
        ...
        /// <see href="https://website/animancer/docs/bugs/animator-controller-speed">Animator Controller Speed</see>
        ...
        /// <summary>
        /// <see href="https://website/animancer/docs/manual/ik">Inverse Kinematics</see> cannot be
        /// dynamically enabled on some <see href="https://website/animancer/docs/manual/playing/states">States</see>
        /// Types.
        /// </summary>
        /// 
        /// <remarks>
        ...
        /// <summary>
        /// A <see cref="MixerState"/> is synchronizing a child with <see cref="AnimatorProState.Length"/> = 0.
        /// </summary>
        /// 
        /// <remarks>
        /// Synchronization is based on the <see cref="AnimatorProState.NormalizedTime"/> which can't be calculated if
        /// the <see cref="AnimatorProState.Length"/> is 0.
        /// <para></para>
        /// Some state types can change their <see cref="AnimatorProState.Length"/>, in which case you can just disable
        ...
        /// <summary>
        /// A <see href="https://website/animancer/docs/manual/blending/fading#custom-fade">Custom Fade</see>
        ...
        /// <see href="https://website/animancer/docs/manual/blending/fading#custom-fade">Custom Fade</see>.
        /// </summary>
        /// 
        /// <remarks>
        /// Passing a <c>null</c> parameter into <see cref="CustomFade.Apply(AnimatorProState, AnimationCurve)"/> and
    ...
    /// https://website/animancer/api/AnimatorPro/Validate
    public static partial class Validate
    {
        ...
        public static void Log(this OptionalWarning type, string message, object context = null)
        {
            ...
            Debug.LogWarning($"Possible Bug Detected: {message}\n\nThis warning can be disabled via the " +
                ...
                $" or by calling {nameof(AnimatorPro)}.{nameof(OptionalWarning)}.{type}.{nameof(Disable)}()" +
        ...
        private const string PermanentlyDisabledWarningsKey = nameof(AnimatorPro) + "." + nameof(PermanentlyDisabledWarnings);
