...
namespace AnimatorPro
{
    ...
    /// <remarks>
    /// Documentation: <see href="https://website/animatorpro/docs/manual/playing/directional-sets">Directional Animation Sets</see>
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/DirectionalAnimationSet
    /// 
    ...
    public class DirectionalAnimationSet : ScriptableObject, IAnimationClipSource
    {
        ...
        /// Documentation: <see href="https://website/animatorpro/docs/manual/playing/directional-sets">Directional Animation Sets</see>
        /// </remarks>
        /// https://website/animatorpro/api/AnimatorPro/Direction
        /// 
        ...
        private class Editor : AnimatorPro.Editor.ScriptableObjectEditor { }
        ...
        private static void ToggleLooping(UnityEditor.MenuCommand command)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                for (i = 0; i < count; i++)
                {
                    ...
                    AnimatorPro.Editor.AnimancerEditorUtilities.SetLooping(clip, isLooping);
                }
