...
using AnimatorPro.Units;
using UnityEngine;

namespace AnimatorPro
{
    /// <summary>Various string constants used throughout <see cref="AnimatorPro"/>.</summary>
    /// https://website/animatorpro/api/AnimatorPro/Strings
    /// 
    public static class Strings
    {
        ...
        public const string ProductName = nameof(AnimatorPro);
        ...
        /// "Assets/Create/animatorpro/..." menu items just under "Avatar Mask".
        /// </summary>
        ...
        /// https://website/animatorpro/api/AnimatorPro/DocsURLs
        /// 
        public static class DocsURLs
        {
            ...
            public const string Documentation = "https://website/animancer";

            /// <summary>The URL of the website where the Animancer API documentation is hosted.</summary>
            public const string APIDocumentation = Documentation + "/api/" + nameof(AnimatorPro);
            ...
            public const string DeveloperEmail = "animancer@website";

            /************************************************************************************************************************/

            public const string OptionalWarning = APIDocumentation + "/" + nameof(AnimatorPro.OptionalWarning);
            ...
            public const string Issues = "https://github.com/website/animatorpro/issues";
        ...
        /// https://website/animatorpro/api/AnimatorPro/Tooltips
        /// 
