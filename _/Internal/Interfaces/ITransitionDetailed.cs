...
namespace AnimatorPro
{
    ...
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/ITransitionDetailed
    /// 
    public interface ITransitionDetailed : ITransition
    {
        ...
        /// <summary>What will the value of <see cref="AnimatorProState.IsLooping"/> be for the created state?</summary>
        bool IsLooping { get; }

        /// <summary>The <see cref="AnimatorProState.NormalizedTime"/> to start the animation at.</summary>
