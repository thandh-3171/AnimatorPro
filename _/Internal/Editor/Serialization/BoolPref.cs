...
namespace AnimatorPro.Editor
{
    ...
    /// <see href="https://website/inspector-gadgets">Inspector Gadgets</see>.
    /// </summary>
    /// https://website/animatorpro/api/AnimatorPro.Editor/BoolPref
    /// 
    public sealed class BoolPref
    {
        ...
        public const string KeyPrefix = nameof(AnimatorPro) + "/";
