...
namespace AnimatorPro
{
    ...
    /// </summary>
    /// <remarks>
    /// Documentation: <see href="https://website/animatorpro/docs/manual/animator-controllers#hybrid">Hybrid</see>
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/HybridAnimancerComponent
    /// 
    ...
    public class HybridAnimancerComponent : NamedAnimatorProComponent
    {
        /************************************************************************************************************************/
        ...
        /// <summary>Starts a transition from the current state to the specified state using normalized times.</summary>
        /// <remarks>If `fadeDuration` is negative, it uses the <see cref="AnimancerPlayable.DefaultFadeDuration"/>.</remarks>
        public AnimatorProState CrossFade(
            string stateName,
            float fadeDuration = ControllerState.DefaultFadeDuration,
            int layer = -1,
            float normalizedTime = float.NegativeInfinity)
        ...
        /// <summary>Starts a transition from the current state to the specified state using times in seconds.</summary>
        /// <remarks>If `fadeDuration` is negative, it uses the <see cref="AnimancerPlayable.DefaultFadeDuration"/>.</remarks>
        public AnimatorProState CrossFadeInFixedTime(
            string stateName,
            float fadeDuration = ControllerState.DefaultFadeDuration,
            int layer = -1,
            float fixedTime = 0)
        ...
        /// <summary>Plays the specified state immediately, starting from a particular time (in seconds).</summary>
        public AnimatorProState PlayInFixedTime(
            string stateName,
            int layer = -1,
            float fixedTime = 0)
        {
