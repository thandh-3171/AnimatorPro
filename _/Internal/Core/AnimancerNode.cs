...
namespace AnimatorPro
{
    ...
    /// https://website/animatorpro/api/AnimatorPro/AnimatorProNode
    /// 
    public abstract class AnimancerNode : Key, IUpdatable, IEnumerable<AnimatorProState>, IEnumerator, IPlayableWrapper
    {
        /************************************************************************************************************************/
        #region Playable
        /************************************************************************************************************************/
        ...
        /// <see cref="AnimatorProState.SetParent"/> should also be able to set it, but classes that further inherit from
        ...
        /// The number of states using this node as their <see cref="AnimatorProState.Parent"/>.
        /// </summary>
        ...
        /// </summary>
        /// <exception cref="NotSupportedException">This node can't have children.</exception>
        public virtual AnimatorProState GetChild(int index)
            => throw new NotSupportedException(this + " can't have children.");

        /// <summary>Called when a child is connected with this node as its <see cref="AnimatorProState.Parent"/>.</summary>
        /// <exception cref="NotSupportedException">This node can't have children.</exception>
        protected internal virtual void OnAddChild(AnimatorProState state)
        {
            state.ClearParent();
            throw new NotSupportedException(this + " can't have children.");
        }

        /// <summary>Called when a child's <see cref="AnimatorProState.Parent"/> is changed from this node.</summary>
        /// <exception cref="NotSupportedException">This node can't have children.</exception>
        protected internal virtual void OnRemoveChild(AnimatorProState state)
        {
            state.ClearParent();
            throw new NotSupportedException(this + " can't have children.");
        }
        ...
        protected void OnAddChild(IList<AnimatorProState> states, AnimatorProState state)
        {
        ...
        public virtual FastEnumerator<AnimatorProState> GetEnumerator() => default;

        IEnumerator<AnimatorProState> IEnumerable<AnimatorProState>.GetEnumerator() => GetEnumerator();
        ...
        /// <see cref="AnimatorProState.IsPlaying"/> so a state can be paused at any point and still show its pose on the
        ...
        /// <summary>[Pro-Only] How fast the <see cref="AnimatorProState.Time"/> is advancing every frame (default 1).</summary>
        /// 
        /// <remarks>
        /// A negative value will play the animation backwards.
        /// <para></para>
        /// To pause an animation, consider setting <see cref="AnimatorProState.IsPlaying"/> to false instead of setting
        /// this value to 0.
        /// <para></para>
