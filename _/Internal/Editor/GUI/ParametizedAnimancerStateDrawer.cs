...
namespace AnimatorPro.Editor
{
    ...
    /// https://website/animatorpro/api/AnimatorPro.Editor/ParametizedAnimancerStateDrawer_1
    /// 
    public abstract class ParametizedAnimancerStateDrawer<T> : AnimancerStateDrawer<T> where T : AnimatorProState
    {
        /************************************************************************************************************************/
