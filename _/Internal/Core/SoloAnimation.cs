...
namespace AnimatorPro
{
    ...
    /// </remarks>
    /// <example>
    /// <see href="https://website/animatorpro/docs/examples/fine-control/solo-animation">Solo Animation</see>
    /// </example>
    /// https://website/animatorpro/api/AnimatorPro/SoloAnimation
    /// 
