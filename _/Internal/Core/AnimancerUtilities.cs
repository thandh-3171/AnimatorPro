...
namespace AnimatorPro
{
    ...
    public static partial class AnimancerUtilities
    {
        ...
        public static AnimatorProState CreateStateAndApply(this ITransition transition, AnimancerPlayable root = null)
        {
        ...
        /// Calculates all thresholds in the `mixer` using the <see cref="AnimatorProState.AverageVelocity"/> of each
