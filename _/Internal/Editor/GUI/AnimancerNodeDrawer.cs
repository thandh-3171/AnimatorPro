...
namespace AnimatorPro.Editor
{
    ...
    /// https://website/animatorpro/api/AnimatorPro.Editor/IAnimancerNodeDrawer
    /// 
    ...
    /// <summary>[Editor-Only] Draws the Inspector GUI for an <see cref="AnimancerNode"/>.</summary>
    /// https://website/animatorpro/api/AnimatorPro.Editor/AnimancerNodeDrawer_1
    /// 
    public abstract class AnimancerNodeDrawer<T> : IAnimancerNodeDrawer where T : AnimancerNode
    {
        ...
        /// <summary>
        /// Draws a field for the <see cref="AnimatorProState.MainObject"/> if it has one, otherwise just a simple text
        /// label.
        /// </summary>
        ...
        /// <summary>
        /// Draws controls for <see cref="AnimatorProState.IsPlaying"/>, <see cref="AnimancerNode.Speed"/>, and
        ...
        protected void DoNodeDetailsGUI()
        {
            ...
            // Is Playing.
            var state = Target as AnimatorProState;
            if (state != null)
            {
