...
namespace AnimatorPro
{
    ...
    /// </summary>
    /// https://website/animatorpro/api/AnimatorPro/Validate
    /// 
    public static partial class Validate
    {
        ...
        public static void AssertPlayable(AnimancerNode node)
        {
            ...
            if (node is AnimatorProState state)
                state.Destroy();
            ...
            if (node.Root == null)
                throw new InvalidOperationException(
                    ...
                    $" or calling {nameof(AnimatorProState.SetRoot)} on it directly." +
                    $" {nameof(AnimatorProState.SetParent)} would also work if the parent has a {nameof(AnimancerNode.Root)}." +
                    $"\n• State: {description}");
            else
                throw new InvalidOperationException(
        ...
        /// </exception>
        [System.Diagnostics.Conditional(Strings.Assertions)]
        public static void AssertCanRemoveChild(AnimatorProState state, IList<AnimatorProState> states)
        {
#if UNITY_ASSERTIONS
            ...
            if (index > states.Count)
                throw new IndexOutOfRangeException(
                    $"{nameof(AnimatorProState)}.{nameof(state.Index)} ({state.Index})" +
