...
{
    /// <inheritdoc/>
    /// https://website/animatorpro/api/AnimatorPro/ClipTransitionAsset
    ...
    /// <inheritdoc/>
    /// https://website/animatorpro/api/AnimatorPro/ClipTransition
    [Serializable]
    public class ClipTransition : AnimancerTransition<ClipState>, ClipState.ITransition, IMotion, IAnimationClipCollection
    {
        ...
        /// <summary>Returns the <see cref="Clip"/> to use as the <see cref="AnimatorProState.Key"/>.</summary>
        ...
        /// <summary>
        /// If this transition will set the <see cref="AnimatorProState.Time"/>, then it needs to use
        ...
        /// <inheritdoc/>
        public override void Apply(AnimatorProState state)
        {
