...
namespace AnimatorPro.Editor
{
    ...
    /// <see cref="AnimatorPro.Editor.TransitionPreviewWindow"/> or viewing an <see cref="AnimationTimeAttribute"/>.
    /// <para></para>
    /// The default location is <em>Assets/Plugins/animatorpro/Editor</em>, but you can freely move it (and the whole
    /// AnimatorPro folder) anywhere in your project.
    /// <para></para>
    /// These settings can also be accessed in <see cref="AnimancerToolsWindow.Settings"/> panel in the
    /// <see cref="AnimatorPro.Editor.AnimancerToolsWindow"/> (<c>Window/Animation/Animancer Tools</c>).
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro.Editor/AnimancerSettings
    /// 
