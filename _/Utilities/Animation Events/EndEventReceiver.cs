...
namespace AnimatorPro
{
    ...
    /// <see cref="AnimancerEvent.Sequence.endEvent"/> of the <see cref="AnimatorProState"/> that triggered the event.
    /// </summary>
    /// <remarks>
    ...
    /// <para></para>
    /// Documentation: <see href="https://website/animatorpro/docs/manual/events/animation#end-animation-events">End Animation Events</see>
    /// </remarks>
    /// https://website/animatorpro/api/AnimatorPro/EndEventReceiver
    /// 
    ...
    public class EndEventReceiver : MonoBehaviour
    {
        ...
        /// <summary>
        /// Tries to invoke the <see cref="AnimancerEvent.Sequence.endEvent"/> of the <see cref="AnimatorProState"/> that
        ...
        public static bool End(AnimancerComponent animancer, AnimationEvent animationEvent)
        {
            ...
            {
                Debug.LogWarning($"{nameof(AnimationEvent)} '{nameof(End)}' was triggered by {animationEvent.animatorClipInfo.clip}" +
                    $", but no state was found with that {nameof(AnimatorProState.Key)}.",
                    animancer);
            }
        ...
        /// <summary>
        /// If the <see cref="AnimatorProState.Clip"/> and <see cref="AnimancerNode.Weight"/> match the
        /// <see cref="AnimationEvent"/>, this method invokes the <see cref="AnimancerEvent.Sequence.OnEnd"/> callback
        /// and returns true.
        /// </summary>
        private static bool TryInvokeOnEndEvent(AnimatorProState state, AnimationEvent animationEvent)
        {
